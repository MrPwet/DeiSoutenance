...
\begin{figure}[h!]
    \captionsource{Comparatif des prélèvements par plateforme}{\url{https://www.gittip.com/about/charts.html}}
\begin{center}
\begin{tabular}{|c|c|c|}
...
\begin{figure}[h!]
    \captionsource{Nombre d'utilisateurs en fonction du temps}{\url{https://www.gittip.com/about/charts.html}}
  \centering
    \includegraphics[width=16cm]{images/gittip_amount.eps}
\end{figure}
\begin{figure}[h!]
    \captionsource{Somme échangée au sein de Gittip (en \$) en fonction du temps}{\url{https://www.gittip.com/about/charts.html}}
  \centering
