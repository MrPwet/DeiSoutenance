...
\title[D.E.I - Gittip]{Gittip a-t-il une chance de s'imposer comme un système
de financement reconnu et répandu en France aussi bien qu'à l'étranger ?}
...
\begin{frame}[plain]
	\begin{textblock}{0}(5,-30)
        \center{\includegraphics[width=.7\paperwidth]{images/gittip.eps}}
	\end{textblock}
\end{frame}
